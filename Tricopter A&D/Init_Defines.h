...
#define SIM	0x001
#define C_TMR1_TIME 0x0feE2	// 1Mhz interrupt rate	//0x0FFD0


#define cLEDBLINK 0x004 //defined again in init_asm_h
#define	cTAGCLOCK 0x007
#define cTAGDATA  0x006

    //ubProcessByte
#define cbtLastClkState 0x000
